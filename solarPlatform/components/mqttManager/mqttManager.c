...
static char *create_json_device(const char *device_id, const char *status) {
...
static void mqtt_event_handler(void *handler_args, esp_event_base_t base,
  ...
  case MQTT_EVENT_CONNECTED:
    ...
    esp_mqtt_client_publish(client, "devices/connected",
                            create_json_device(clientID, "connected"), 0, 2, 1);
      ...
      .session.last_will =
          {
              ...
              .msg = create_json_device(clientID, "disconnected"),
              .msg_len = 0,
              .qos = 2,
              .retain = 0,
          },
